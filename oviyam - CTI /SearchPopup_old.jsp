	...
	<tr>
		<td>
			<table class="searchTable">
				...
				<tr>
					<td>
						<input  type="radio" name="group1" value="LastWeek" onclick="$('from').value='';$('to').value='';">Ultima Semana
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="group1" value="LastMonth" onclick="$('from').value='';$('to').value='';">Ultimo mes
					</td>
				</tr>
				<tr>
					<td colspan=2>
						<input type="radio" name="group1" value="between" >Entre
					</td>
				</tr>
				<tr>
					<td>
