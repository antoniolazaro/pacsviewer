	...
	function setImageInfos(totalImages){
		...
		cineloop=1;
		cineLoop();
		$('loadingText').innerHTML='Carregando as Imagens...';
	}	
	...
	function setPatientInfos(){
		...
		{	
		    ...
		    window.document.title='Gnect Viewer -'+$("patname").innerHTML;;
		    if(!$('loadingText'))return;
		    else
		    $('loadingText').innerHTML='Carregando series...';
		}
	}
	...
	function setPatientInfoVisible(patientName){
		...
		window.document.title='Gnect Viewer -'+patientName;
		if(!$('loadingText'))return;
		else
		$('loadingText').innerHTML='Carregando series...';
		}
	...
	function hideTools(){
		...
		if(hidetool==0){
			...
			document.getElementById("hideButton").value = "Esconder ferramentas";
			...
			document.getElementById("hideButton").value = "Exibir ferramentas";
	...
	function loadFile(){
		...
		{
			alert('Os campos de data estão vazias..!');
			return;
		}
