...
<div id="resetButton" class="toolBarButton" onclick="resetAll();">
	<div class="toolBarText toolBarTextNonMode">Reiniciar</div>
</div>

<div id="moveButton" class="toolBarButton moveButton">
	<div class="toolBarText" id="moveText">Mover</div>
</div>

<div id="measureButton" class="measureButton toolBarButton">
	<div class="toolBarText" id="measureText">Medir</div>
</div>
		...
		<table>
			<ser:Series patientId="${param.patientID}" study="${param.studyUID}">
				<tr>
					...
					<div class="seriesDetails">Total de Imagens : ${numberOfImages}</div>
					<div id="image"><A HREF=""
...
<table width="100%">
	<tr>
		...
		<div class="label">Mudança da cor do fundo da tela:&nbsp;</div>
...
<div id="loadingText" class="loadingText">Carregando...</div>
</div>
</div>
...
<button class="resetStyle" type="reset" 
	onclick="resetForm();">
<div class="outer">
<div class="label">Reiniciar filtros</div>
</div>
</button>
