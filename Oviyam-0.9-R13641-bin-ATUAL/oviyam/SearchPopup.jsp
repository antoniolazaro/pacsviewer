	...
	<tr>
		<td>
			<table class="searchTable">
				<tr>
					<td>
						<input  type="radio" name="group1" value="All Date" checked="checked" onclick="$('from').value='';$('to').value='';">Qualquer data
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input  type="radio" name="group1" value="LastWeek" onclick="$('from').value='';$('to').value='';">&Uacute;ltima Semana
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="group1" value="LastMonth" onclick="$('from').value='';$('to').value='';">&Uacute;ltimo m&ecirc;s
					</td>
				</tr>
				<tr>
					<td colspan=2>
						<input type="radio" name="group1" value="between" >Intervalo
					</td>
				</tr>
				<tr>
					<td>
						<table>
							<tr>
								...
								<input name="from" id="from" value="" size="10"> 
									<input value="de" onclick="displayDatePicker('from', this);document.getElementsByName('group1')[5].checked=true;" type="button">	
								</td>
							</tr>
							<tr>
								
								<td><input id="to" name="to" value="" size="10">
								<input value="at&eacute;" onclick="displayDatePicker('to', this);document.getElementsByName('group1')[5].checked=true;" type="button"></td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<td>
			<table class="searchTable">
				<tr>
					<td>ID do paciente</td><td><input type="text" name="patientId" id="patientId" value=""></td>
				</tr>
				<tr>
					<td>Nome do paciente</td><td><input type="text" name="patientName" id="patientName" value=""></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Nascimento</td><td><input name="birthDate" id="birthDate" value="">
					<input value="Selecionar Data" onclick="displayDatePicker('birthDate', this);" type="button"></td>
				</tr>
			</table>
		</td>
		<td >
